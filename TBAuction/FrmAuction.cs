...
namespace TBAuction
{
    public partial class frmAuction : Form
    {
        ...
        private void AuctionOperation()
        {
            ...
            string productPostData = productPageHandle.GetProductPostData(productPage, properties, chkProperties.Checked, out isSkuidNull, out questionAnswer);
            ...
            if (string.IsNullOrEmpty(submitAddress))
            {
                ...
                if (string.IsNullOrEmpty(submitAddress))
                {
                    ...
                    else
                    {
                        ...
                        cc.Add(ccReturned);
                        if (resultAddress.IndexOf("正在处理中，请稍候") > -1 || resultAddress.IndexOf("AlipayPay") > -1)
                        {
        ...
        private void btnAuct_Click(object sender, EventArgs e)
        {
            ...
            {
                properties = "尺码:" + txtSize.Text.Trim() + ";" + "颜色分类:" + txtColor.Text.Trim();
            }
        ...
        private void chkTeminateTime_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void txtTeminateTime_TextChanged(object sender, EventArgs e)
        {
